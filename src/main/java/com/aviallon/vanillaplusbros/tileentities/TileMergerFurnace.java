 ...
 */
public class TileMergerFurnace extends TileEntity implements IInventory, ITickable {
    ...
    private boolean canSmelt() {
        if(((ItemStack)this.inventory.get(0)).isEmpty() || ((ItemStack)this.inventory.get(1)).isEmpty())
            ...
            ItemStack result = MergerRecipes.instance().getDualSmeltingResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));
    ...
    public void smeltItem() {
        if(this.canSmelt()) {
            ...
            ItemStack result = MergerRecipes.instance().getDualSmeltingResult(input1, input2);
            ItemStack output = (ItemStack)this.inventory.get(3);

            if(output.isEmpty())
                this.inventory.set(3, result.copy());
            else if(output.getItem() == result.getItem()){
                int totalItems = output.getCount() + result.getCount();
                if(totalItems <= output.getMaxStackSize()) {
