...
public class BlockMerger extends Block implements ITileEntityProvider {
    ...
    public BlockMerger() {
        ...
        setUnlocalizedName(Reference.VanillaPlusBroBlocks.MERGER.getUnlocalizedName());
        setRegistryName(Reference.VanillaPlusBroBlocks.MERGER.getRegistryName());
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(ModBlocks.merger);
    }
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos) {
        ...
        if(active) {
            //lightValue = 0.5F;
            worldIn.setBlockState(pos, ModBlocks.merger.getDefaultState().withProperty(FACING, state.getValue(FACING)).withProperty(BURNING, true), 3);
        } else {
            //lightValue = 0.0F;
