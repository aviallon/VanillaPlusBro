...
public class BlockRedstoneCable extends Block {
    public static final PropertyEnum<BlockRedstoneCable.EnumAttachPosition> NORTH = PropertyEnum.<BlockRedstoneCable.EnumAttachPosition>create("north", BlockRedstoneCable.EnumAttachPosition.class);
    public static final PropertyEnum<BlockRedstoneCable.EnumAttachPosition> EAST = PropertyEnum.<BlockRedstoneCable.EnumAttachPosition>create("east", BlockRedstoneCable.EnumAttachPosition.class);
    public static final PropertyEnum<BlockRedstoneCable.EnumAttachPosition> SOUTH = PropertyEnum.<BlockRedstoneCable.EnumAttachPosition>create("south", BlockRedstoneCable.EnumAttachPosition.class);
    public static final PropertyEnum<BlockRedstoneCable.EnumAttachPosition> WEST = PropertyEnum.<BlockRedstoneCable.EnumAttachPosition>create("west", BlockRedstoneCable.EnumAttachPosition.class);
    ...
    {
        super(Material.ROCK);
        this.setDefaultState(this.blockState.getBaseState().withProperty(NORTH, BlockRedstoneCable.EnumAttachPosition.NONE).withProperty(EAST, BlockRedstoneCable.EnumAttachPosition.NONE).withProperty(SOUTH, BlockRedstoneCable.EnumAttachPosition.NONE).withProperty(WEST, BlockRedstoneCable.EnumAttachPosition.NONE).withProperty(POWER, Integer.valueOf(0)));
    ...
    {
        int i = 0;
        boolean flag = state.getValue(NORTH) != BlockRedstoneCable.EnumAttachPosition.NONE;
        boolean flag1 = state.getValue(EAST) != BlockRedstoneCable.EnumAttachPosition.NONE;
        boolean flag2 = state.getValue(SOUTH) != BlockRedstoneCable.EnumAttachPosition.NONE;
        boolean flag3 = state.getValue(WEST) != BlockRedstoneCable.EnumAttachPosition.NONE;
    ...
    private BlockRedstoneCable.EnumAttachPosition getAttachPosition(IBlockAccess worldIn, BlockPos pos, EnumFacing direction)
    {
        ...
        if (!canConnectTo(worldIn.getBlockState(blockpos), direction, worldIn, blockpos) && (iblockstate.isNormalCube() || !canConnectUpwardsTo(worldIn, blockpos.down())))
        {
            ...
            if (!iblockstate1.isNormalCube())
            {
                ...
                if (flag && canConnectUpwardsTo(worldIn, blockpos.up()))
                {
                    ...
                    {
                        return BlockRedstoneCable.EnumAttachPosition.UP;
                    }

                    return BlockRedstoneCable.EnumAttachPosition.SIDE;
                }
            }

            return BlockRedstoneCable.EnumAttachPosition.NONE;
        }
        else
        {
            return BlockRedstoneCable.EnumAttachPosition.SIDE;
    ...
    protected static boolean canConnectTo(IBlockState blockState, @Nullable EnumFacing side, IBlockAccess world, BlockPos pos )
    {
        ...
        else if (block == ModBlocks.redstonecable){
            return true;
        }
    ...
    {
        return new ItemStack(ModBlocks.redstonecable);
    }
