...
import com.aviallon.vanillaplusbros.slot.SlotMergerFuel;
import com.aviallon.vanillaplusbros.slot.SlotMergerOutput;
 ...
 */
public class ContainerMerger extends Container {
    ...
    public ContainerMerger(InventoryPlayer player, TileMergerFurnace tileentity) {
        this.tileentity = tileentity;
        this.addSlotToContainer(new Slot(tileentity, 0, 20, 18));
        this.addSlotToContainer(new Slot(tileentity, 1, 140, 18));
        this.addSlotToContainer(new SlotMergerFuel(tileentity, 2, 80, 59));
        this.addSlotToContainer(new SlotMergerOutput(player.player, tileentity, 3, 80, 19));
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
        ...
        if(slot != null && slot.getHasStack()) {
            ...
            if(index == 3) {
                ...
                if(!MergerRecipes.instance().getDualSmeltingResult(stack1, slot1.getStack()).isEmpty())
                    if(!this.mergeItemStack(stack1, 0, 2, false))
                        return ItemStack.EMPTY;
                    else if(TileMergerFurnace.isItemFuel(stack1))
